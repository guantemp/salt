...
public final class DigitalToChinese {
    ...
    public static String format(double amount, boolean isUseTraditional, boolean isMoneyMode) {
        ...
        String chineseStr = EMPTY;
        for (int i = 0; i < numParts; i++) {
            String partChinese = toChinese(parts[i], isUseTraditional);
            if (i % 2 == 0) {
                beforeWanIsZero = partChinese == null ? true : partChinese.isEmpty() ? true : false;
            }
...
//		}
    ...
    public static void main(String[] args) {
        System.out.println(DigitalToChinese.toChinese(9733, false));
        System.out.println(DigitalToChinese.toChinese(4633, true));
        System.out.println(DigitalToChinese.format(78112786734.4576, true, true));
        System.out.println(DigitalToChinese.format(78112786734.4576, false, false));
    }
}
