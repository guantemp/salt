...
public final class PinYin {
    ...
    public static void main(String[] args) {
        System.out.println(PinYin.toShortPinYing("泸州广义广告有限公司"));
        System.out.println(PinYin.toPinYing("泸州广义广告有限公司"));
    }
    ...
    private static char convert(byte[] bytes) {
        ...
        if (secPosvalue > 1600 && secPosvalue < 5600) {
            for (int i = 0; i < 23; i++) {
            ...
            if (ioffset >= 0 && ioffset <= 3007) {
                result = SECOND_SEC_TABLE.substring(ioffset, ioffset + 1).charAt(0);
            }
        }
        return result;
    }
