...
public class ConcurrentMapCacheTest {
    private static Cache<Integer, String> cache = new ConcurrentMapCacheBuilder<Integer, String>("test").expired(1, TimeUnit.SECONDS).maxAmount(3).maximumSize(160).build();
