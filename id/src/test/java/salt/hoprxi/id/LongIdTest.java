...
public class LongIdTest {
    ...
    public void timestamp() throws ParseException {
        ...
        System.out.println("2026-01-01 00:00:00(UTC/GMT+08:00) to long:"
                           + LocalDateTime.parse("2026-01-01 00:00:00.000", DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS")).atZone(ZoneId.of("UTC")).toInstant().toEpochMilli());
