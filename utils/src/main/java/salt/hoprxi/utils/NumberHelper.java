...
public class NumberHelper {
    ...
    public static boolean booleanOf(String str) {
        ...
        int value = NumberHelper.intOf(str);
        return value > 0;
    }

    /**
     * @see NumberHelper#byteOf(String str, byte defaultByte)
     */

    public static byte byteOf(String str) {
        return NumberHelper.byteOf(str, (byte) 0);
    }
    ...
    /**
     * @see NumberHelper#doubleOf(String str, double defaultByte)
     */
    public static double doubleOf(String str) {
        return NumberHelper.doubleOf(str, 0.0);
    }
    ...
    public static float floatOf(String str) {
        return NumberHelper.floatOf(str, 0.0f);
    }
    ...
    public static int intOf(String str) {
        return NumberHelper.intOf(str, 0);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("intValue:" + NumberHelper.intOf(null));
        System.out.println("booleanValue:" + NumberHelper.booleanOf("1"));
    ...
    public static short shortOf(String str) {
        return NumberHelper.shortOf(str, (short) 0);
    }
    ...
    public static BigDecimal toBigDecimal(String str) {
        return NumberHelper.toBigDecimal(str, BigDecimal.ZERO);
    }
    ...
    public static BigInteger toBigInteger(String str) {
        return NumberHelper.toBigInteger(str, BigInteger.ZERO);
    }
