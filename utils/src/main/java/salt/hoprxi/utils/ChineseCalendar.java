...
public final class ChineseCalendar extends GregorianCalendar {
    ...
    public static void main(String[] args) {
        System.out.println(new ChineseCalendar(true, 1975, 4, 20).getSimpleGregorianDateString());
        System.out.println(new ChineseCalendar(1975, 4, 20));
        System.out.println(new Date(1453699013723L));
        System.out.println(new ChineseCalendar());
        System.out.println(new ChineseCalendar(new Date(1453699013723L)));
    }
    ...
    public String getChineseDateString() {
        return getChinese(CHINESE_YEAR) + getChinese(CHINESE_MONTH) +
                getChinese(CHINESE_DATE);
    }

    public String getSimpleChineseDateString() {
        return get(CHINESE_YEAR) + "-" +
                (get(CHINESE_MONTH) > 0 ? "" + get(CHINESE_MONTH) : "*" + (-get(CHINESE_MONTH))) + "-" +
                get(CHINESE_DATE);
    }
    ...
    public String toString() {
        return getSimpleGregorianDateString() + " | " + getChinese(DAY_OF_WEEK) + " | [农历]" +
                getChineseDateString() + " " + getChinese(CHINESE_ZODIAC) + "年 " +
                get(CHINESE_SECTIONAL_TERM) + "日" + getChinese(CHINESE_SECTIONAL_TERM) + " " +
                get(CHINESE_PRINCIPLE_TERM) + "日" + getChinese(CHINESE_PRINCIPLE_TERM);
    }
}
