 ...
 */
public class ResourceWherePathTest {

    @Test
    public void testGetAbsolutePath() {
        System.out.println("beging test path:");
        System.out.println(ResourceWherePath.toUniversalFilePath( "watch_dog.properties"));
        System.out.println(ResourceWherePath.toUrl( "watch_dog.properties"));
    }
    ...
    @Test
    public void testToUrlWithPoint() {
    }
}